...
public class spriteSelection : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        flagPlayer1 = GameObject.FindGameObjectsWithTag("FlagP1");
        flagPlayer2 = GameObject.FindGameObjectsWithTag("FlagP2");
    ...
    public void setSprites()
    {
        ...
        foreach (var obj in flagPlayer1)
        {
            if (obj != null)
            {
                ...
                flag.sprite = preGameData.P1FlagSprite;
            }
        }
        ...
        foreach (var obj in flagPlayer2)
        {
            ...
            {
                var flag = obj.transform.GetComponent<SpriteRenderer>();
                flag.sprite = preGameData.P2FlagSprite;
            }
        }
        ...
        else if (preGameData.gameMode == "1vs1")
        {
